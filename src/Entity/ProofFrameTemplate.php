...
#[ORM\Entity(repositoryClass: ProofFrameTemplateRepository::class)]
#[Vich\Uploadable]
class ProofFrameTemplate
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(inversedBy: 'proofFrameTemplates')]
    private ?ProofTemplate $proofTemplate = null;
    ...
    public function getProofTemplate(): ?ProofTemplate
    {
        return $this->proofTemplate;
    }

    public function setProofTemplate(?ProofTemplate $proofTemplate): static
    {

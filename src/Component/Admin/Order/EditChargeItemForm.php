...
#[AsLiveComponent(
  name: "EditChargeItemForm",
  template: "admin/components/order/edit-charge-item.html.twig"
)]
class EditChargeItemForm extends AbstractController
{
  ...
  {
    return $this->createForm(ChargeItemType::class, $this->orderItem, [
      'order' => $this->order
    ]);
  }

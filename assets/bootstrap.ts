...
declare global {
    interface Window {
        stimulusApp: any;
        addProcessOnBtn: (btn: any) => void;
        removeProcessFromBtn: (btn: any, content?: string) => void;
        removeProcessingOrderOverlay: () => void;
        addProcessingOrderOverlay: () => void;
        recaptchaSiteKey: string;
        blurAllFocusable: () => void;

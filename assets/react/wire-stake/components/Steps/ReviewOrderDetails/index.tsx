...
import { postDataToCart } from "@wireStake/components/Steps/ReviewOrderDetails/postDataToCart";
import AddToCart from "./AddToCart";
import { AddToCartContainer, StyledCard, StyledCollapse, TableContainer, TotalAmountContainer } from "./styled";
import { DeliveryMethod } from "@react/wire-stake/redux/reducer/cart/interface";
                    ...
                    {cartStage.totalQuantity > 0 && <TableContainer>
                        <table className="table mb-0">
                            ...
                            <tr className="desktop-only">
                                ...
                                <th>{totalQuantity} {'Wire Stakes'}</th>
                            ...
                            {Object.keys(cartStage.items).length > 0 && <tr>
                                <td colSpan={4}>Wire Stakes Cost Breakdown</td>
                            </tr>}
                            <tr>

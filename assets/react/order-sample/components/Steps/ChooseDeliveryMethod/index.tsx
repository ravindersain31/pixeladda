...
// internal imports
import { useAppDispatch, useAppSelector } from "@orderSample/hook.ts";
import {
    ShippingMethod,
    StyledButton,
    StyledCheckmark,
    StyledRow,
    StyledCol,
} from "@orderSample/components/Steps/ChooseDeliveryDate/styled";
import {
    PopoverContent,
    StyledPopover,
} from "@orderSample/components/Cards/AddonCard/styled";
import actions from "@orderSample/redux/actions";
import { DeliveryMethod, IDeliveryMethodProps } from "@orderSample/redux/reducer/cart/interface";
...
const ChooseDeliveryMethod = memo(() => {
    ...
    return (
        <StyledRow gutter={[8, 8]}>
            {/* Pickup Option */}
            <StyledCol xs={12} sm={8} md={6} lg={4}>
                <ShippingMethod>
                    <StyledButton

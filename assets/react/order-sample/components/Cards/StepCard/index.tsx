...
import { StyledCard } from '@orderSample/components/Cards/StepCard/styled';
import { CardProps, StepCardProps } from '@orderSample/utils/interface';
...
const CardHeader = ({ stepNumber, title }: CardProps) => {
    ...
    const isStepTotalShow = title === "Choose Your Sizes (WxH in Inches)" && isMobile;
    return (
        <>
            ...
            {!isStepTotalShow && <span className="step-total">
                <>

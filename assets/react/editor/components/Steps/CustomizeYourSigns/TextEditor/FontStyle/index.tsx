...
const FontStyle = ({textObjects, objects, optionClassName}: FontStyleProps) => {
    ...
    return <>
        ...
        <FontStyleContainer>
            ...
            {/* <StyledTooltip title="Line Through">
                <LineThrough
                    className={optionClassName}

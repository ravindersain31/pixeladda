...
const BrowseArtwork = () => {
    ...
    const type: string = "BROWSE-ARTWORK";
    ...
    const onCategoryChange = async (option: any) => {
        ...
        await loadArtworks(option.value);
    }
    ...
    const debouncedSearch = _.debounce((value: any) => onSearchChange(value), 300);
    ...
    const onArtworkChoose = (artwork: any) => {
        ...
        addFile(`${baseUrl}/${artwork.image}`, canvas.view);
    }
    ...
    const addFile = (url: string, side: string) => {
        ...
        const index = newData.findIndex((artwork: any) => artwork === url) || 0;
